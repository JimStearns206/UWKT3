...
## 1.2 Read Kaggle Train/Test Files, Convert Existing Features, Add New Features
...
## 1.3 Merge Weather Data with Trap Observations in Train/Test Datasets
...
### Reproduce ARFF datasets for Use in Weka
...
combinedForModeling <- combinedww[,names(combinedww) %in% colsToKeep] 
...
Input: 
    ...
    Classified Attribute: WnvPresent
    Observations: all WnvPresent records, 
        an equal number of !WnvPresent records, randomly sampled.
        
Output: train and test datasets in ARFF format for modeling in Weka.

Discussion: NumMosquitos degraded score. It's not an attribute in test dataset. Not using.

Limitations: Dataset rolls over to a new record if number of mosquitos reaches 50.
