...
The WNVP contest started on April 22nd and will end 17 June 2015. UWKT3's first submission was on May 12th. Its last will be no later than June 9th.
...
Training data included 10,524 records with the following eleven fields:
...
## 4.5 June 7 Linghua Qiu Submittal (Random Forest, Score 0.72228)
...
We used decision trees (Pat), random forests (Linghua), Naive Bayes (Rob), and Generalized Additive Models (Andy). As far as models that we did not time to use during this course, the question of did we skip some models that are highly regarded. In a major comparison of classification algorithms (Caruana & Niculescu-Mizil, ICML 2006), the following was published:
